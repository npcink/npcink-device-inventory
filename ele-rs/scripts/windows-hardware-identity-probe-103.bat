...
echo Collecting read-only hardware identity data for asset 103...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%PS_SCRIPT%" -AssetNumber "103"
set "EXIT_CODE=%ERRORLEVEL%"

echo.
if "%EXIT_CODE%"=="0" (
  echo Completed. Send the 103-windows-hardware-identity-probe.json file from your Desktop for analysis.
) else (
